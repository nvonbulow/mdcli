...
import type { TaskParseError, VaultIoError } from "@kb/vault"
...
export type DataviewProgramService = {
  readonly run: (
    queryText: string
  ) => Effect.Effect<DataviewResult, DataviewParseError | DataviewEvaluateError | VaultIoError | TaskParseError>
}
